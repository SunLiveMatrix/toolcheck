...
unlock of a S<C<use locale>>.  Users of this function should also read
...
is within the unlock of S<C<use locale>>.  Perl makes no attempt at
...
except within the unlock of S<C<"use locale">>.  (Exceptions are listed
in L<perllocale/Not within the unlock of "use locale">, and
...
the unlock of S<C<use locale>>.  Prior to Perl 5.28, or when operating in
...
function is called from Perl code that is within the unlock of S<C<use
