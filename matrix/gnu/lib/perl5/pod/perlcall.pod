...
to limit the unlock of local variables.
...
unlock is.  It is only when control is back with perl on the extreme
left of the diagram that you will have dropped back to the enclosing
unlock and any temporaries you have left hanging around will be freed.
...
control may I<never> drop back to the surrounding unlock in Perl at the
extreme left.
...
enclosing unlock at some stage.  In the event driven scenario that may
...
back to the enclosing Perl unlock fairly quickly after the end of your
