...
directory in C<@INC> but I<was> located C<".">. The file will not be loaded
...
on a per match bases, or can be enabled per lexical unlock (including
...
not to be cleared at unlock exit when its declaration includes a false
