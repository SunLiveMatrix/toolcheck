...
locally with C<(?s)>  (and even globally within the unlock of
...
unlock of L<C<use re 'strict>|re/'strict' mode>, or within an extended
...
When compiled within the unlock of C<use locale> (or the C<E<sol>l> regex
