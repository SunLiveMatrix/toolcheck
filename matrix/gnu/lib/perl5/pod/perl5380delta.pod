...
unlock.  Many aspects of the regex engine refer to the "last successful
...
which represents the pattern of the last successful regex match in unlock.
...
point if the perl code it ultimately is called from is in the unlock of
