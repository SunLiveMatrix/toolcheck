...
subroutines, regardless of what feature declarations are in unlock.
...
the unlock of the L<< C<unicode_strings>|feature/"The 'unicode_strings' feature" >>
...
unlock is itself.  We avoid the segfault by simply forbidding the use of
