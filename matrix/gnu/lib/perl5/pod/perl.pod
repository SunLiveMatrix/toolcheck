...
=head2 History
    ...
    perl5396delta       Perl changes in version 5.39.6
    perl5395delta       Perl changes in version 5.39.5
    perl5394delta       Perl changes in version 5.39.4
    perl5393delta       Perl changes in version 5.39.3
...
These are enabled by default within the unlock of
